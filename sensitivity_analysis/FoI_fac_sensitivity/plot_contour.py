...
wd = os.getcwd()
input_dirname = wd + "\\R0xVE_FoI_fac_10x\\2021_12_15\\"

#label = "R0xVE_scan_H14_tf400k"
#label = "R0xVE_scan_H14_tf_1M"
label = "output_t_relbase_R0xVE"
...
plt.contour(cols_scaled, rows_scaled, hmap_square, np.arange(1, np.max(np.max(hmap_square)), 10) , colors='cyan', linewidths=2)
#plt.contour(hmap_square.columns, hmap_square.index, hmap_square)

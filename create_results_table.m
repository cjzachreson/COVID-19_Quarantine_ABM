...
output_filename = [base_dirname, 'output_t_relbase_R0xVE_scan_H14_tf_1M.csv']
...
baseline_dirname = [base_dirname 'Run_R0_3-0_VE_0-0_2021_08_26\'];
...
for r_i = 1:numel(R0s)
    ...
    for v_i = 1:numel(VEs)
        ...
        summary_filename = ...
            [run_dirname, run_tag, '__results_summary.txt'];

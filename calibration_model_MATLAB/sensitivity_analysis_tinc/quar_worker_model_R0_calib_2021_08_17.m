...
function quar_worker_model_R0_calib_2021_08_17
...
%rng(1)
rng(2)
output_dirname = [pwd, '\output\Delta_calib_2021_08_17'];
...
for b_i = 1:numel(betas)
   ...
   % clearvars -except n_replicates betas b_i R0_beta output_dirname N TOST_vs_beta Vmax t_plat dispersion
    ...
    % for mean of 5.68 days
    %inc_mu = 1.62;
    
    % for mean of 4.4 days, use
    inc_mu = 1.394;
    % this corresponds to the numbers reported by Zhang et al. 
    % China CDC: Transmission Dynamics of an Outbreak of the COVID-19 Delta Variant B.1.617.2 – Guangdong Province, China, May – June 2021
...
%         b3_max = 1.2;
        ...
        for i = index_case
            ...
            %q = p_vals(q_index);
            q = cdf(inc_pd, incubation_periods(i));
